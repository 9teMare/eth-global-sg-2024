...
export const OpIcon = () => {
    return (
        ...
        <path  d="M177.1,316.4c-14.9,0-27.1-3.5-36.6-10.5c-9.4-7.1-14.1-17.3-14.1-30.4c0-2.8,0.3-6.1,0.9-10.1
        ...
        <path  d="M259.3,314.6c-1.4,0-2.4-0.4-3.2-1.3c-0.6-1-0.8-2.1-0.6-3.4l25.9-122c0.2-1.4,0.9-2.5,2.1-3.4
...
export const MinaIcon = () => {
    return (
        ...
        />
        <path  d="M16,24c0.3,0,0.5-0.1,0.7-0.2c0.2-0.2,0.3-0.4,0.3-0.7l0.2-1.2c-0.8,0.2-1.6,0.2-2.4,0l0.2,1.2
